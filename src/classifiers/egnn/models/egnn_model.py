...
class dgEGNN(pl.LightningModule):
    ...
    def forward(self, graph):
        ...
        nodes = graph.x.float() # node features: whether node is on ab/ag, one-hot encoded type
